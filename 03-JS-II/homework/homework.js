...
function estaEnRango(numero) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  if(20<numero<50){return true;} else {return false;}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num1!==0 && num2!==0 && num3!==0){
    if(num1>0 && num2>0 && num3>0){
      if(num1>num2 && num1>num3){return "Número 1 es mayor y positivo";}else if (num3>num1 && num3>num2){num3=num3+1; return num3;} else {return "Error";}
    }else if(num1<0 || num2<0 || num3<0){return "Hay negativos";}else{return "Error";}
    }else{return "Error";}
}
...
function esPrimo(numero) {
  ...
  if (numero<-1 || numero<1){for (let cnte=0;cnte<numero; cnte=0){
    if(numero%cnte===0){
      if(numero/cnt===1){
        if(numero===cnte){
          return true;
...
function esVerdadero(valor){
  ...
  if(valor === false){return 'Soy falso';}else {return 'Soy verdadero';}
...
function doWhile(numero) {
  ...
  let cnt=0;
  let res=0;
  do{cnt=cnt+1; numero=numero*5;}while(cnt<8);
}
