...
function saludo(idioma) {
  ...
  // Tu código:
  if(idioma==="aleman"){return "Guten Tag!";}else if (idioma==="mandarin"){return "Ni Hao!";}else if(idioma==="ingles"){return "Hello!";}else 
...
else if (num3>num1 && num3>num2){num3++;return num3;}else{return false;}
...
function esPrimo(numero) {
  ...
  for (var num=2 ; numero>num;num++){if (numero%num===0){return false;}  } 
  return true;
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (99<numero && numero<1000){return true;}else{return false;}
}
