...
function tienenMismaLongitud(str1, str2) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  if (str1.length!==str2.length){return false;}else{return true;}
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra.length===1){
    if (letra==='a' || letra==='e'|| letra ==='i' || letra === 'o' || letra=== 'u'){return 'Es vocal'}else{'Dato incorrecto';}
