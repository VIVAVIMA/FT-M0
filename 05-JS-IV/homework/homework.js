...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var multp=objetoMisterioso.numeroMisterioso*5;
  return multp;
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  var summ=0;
  for (var cont=0;cont<usuario.posts.length;cont++){
    summ= summ+usuario.posts[cont].likes;
  }
  return summ;
}
